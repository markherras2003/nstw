jQuery(document).ready(function ($) {
	$(document).on('click', '#qwerty', function () {
		$('html,body').animate({
			...
			'slow');
		$("#mcontent").addClass('visible');
		$("#mimage").addClass('invisible');
	});

	$(document).on('click', '#qwerty2', function () {
		$('html,body').animate({
	...
	$(document).on('click', '#qwerty3', function () {
		$('html,body').animate({
	...
	$(document).on('click', '#qwerty2up', function () {
		$('html,body').animate({
	...
	$(document).on('click', '#qwerty3up', function () {
		$('html,body').animate({
			scrollTop: $("#secondpage").offset().top},
			'slow');
		//$("#mcontent").addClass('visible');
